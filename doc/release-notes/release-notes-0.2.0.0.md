EsZett version 0.2.0.0 is now available from:
...
EsZett data directory (listed below) and delete everything except the
wallet.dat and eszett.conf

Linux : ~/.eszett/

Windows : %appdata%\Roaming\EsZett
...
- `62a3da1` Update GitHub URLs to point to EsZettFoundation/eszett
...
- `19ca0ef` Point GitHub URL to EsZettFoundation
