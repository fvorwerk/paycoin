...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EsZett " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are eszett dns seeds.
static const char *strDNSSeed[][2] = {
    {"dnsseed.eszett.com", "dnsseed.eszett.com"},
    {"dnsseed.eszettfoundation.org", "dnsseed.eszettfoundation.org"},
    {"dnsseed.xszdev.org", "dnsseed.xszdev.org"},
    {"tseed.eszett.com", "tseed.eszett.com"},
    {"testnet-seed.eszett.mitchellcash.com", "testnet-seed.eszett.mitchellcash.com"} // Mitchell Cash
};
...
unsigned int pnSeed[] =
{
    // Hard Code DNS Seed IPS for EsZett, eszettfoundation, xszdev
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EsZett is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // eszett: mint proof-of-stake blocks in the background
